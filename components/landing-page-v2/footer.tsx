    ...
    <footer className="bg-gray-800">
      <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
          <div>
            <h3 className="mb-6 text-sm font-semibold text-gray-900 uppercase !text-white">
              Company
            </h3>
        ...
        <div className="text-center">
          ...
          <span className="block text-sm text-center text-gray-500 !text-gray-400">
            ...
            <a
              ...
              className="text-purple-600 hover:underline !text-purple-500"
            >
              Flowbite
            </a>{" "}
            and{" "}
          ...
          <ul className="flex justify-center mt-5 space-x-5">
            <li>
              <a
                href="#"
                className="text-gray-500 hover:text-gray-900 !hover:text-white !text-gray-400"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
